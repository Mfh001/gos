...
task :generate_config => :environment do
  config_dir = File.expand_path("src/app/game_data/source")
  sheets = []

  parser_path = File.expand_path("src/app/game_data/custom_config_parser.rb")
  ...
  `mkdir -p src/app/game_data/gen/`

  table_map.each do |table_name, data|
    data_path = "src/app/game_data/gen/#{table_name}.go"
